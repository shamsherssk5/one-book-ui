...
const Auth = ({ setToken, setCurrentUser }) => {
    const slides = { "signIn": SIGNIN, "signUp": SIGNUP, "forgotP": FORGOTP, "resetP": RESETP };
                ...
                <div class="container bg-white mt-4 p-0">
                    <div class="row no-gutters">
                        <div class="col-md-6 align-self-center">
                            <SignIn setToken={setToken} setCurrentUser={setCurrentUser} setInnerContent={setInnerContent} innerContent={innerContent} />
                            <SignUpCom setInnerContent={setInnerContent} innerContent={innerContent} />
                            <ForgotPassword setInnerContent={setInnerContent} innerContent={innerContent} />
                            <ResetPassword setInnerContent={setInnerContent} innerContent={innerContent} />
                        </div>
                        <div class="col-md-6 text-center auth-comic">
                            <div class="sign-in-detail text-white">
                                <h3 class="mb-5 text-dark welcome-text" href="javascript:void(0);">Welcome to OneBook!</h3>
                                <div class="item">
                                    <img src={slides[innerContent]} class="img-fluid mb-4" style={{ marginLeft: innerContent === 'signIn' ? "-60px" : "0" }} title={innerContent} />
                                </div>
                            </div>
                        </div>
                    </div>
