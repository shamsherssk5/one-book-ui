        ...
        await axios
            ...
            .then((res) => {
                if (res.data.error) {
                    ...
                    setOriginalData(res.data.map(m=>{
                        m['history']=[];
                        m['conversations']=[];
                        m['attachments']=[];
                        return m;
        ...
        <div className="main-left-right-div-container myscrollbar">
                        ...
                        overlay={
                            <Popover>
                                <div className="popup">
                                    ...
                                    <p onClick={() => {setRightContent("Edit");document.body.click()}}>
                                        Edit Selected
                                    </p>
            ...
            <div className="main-right-div">
                <div className="right-div-header">
                    ...
                    {rightContent === "Create" && (
                        <span className={"right-sub-header-1 clicked"}>
                            Contacts
                        </span>
                    )}
                </div>
